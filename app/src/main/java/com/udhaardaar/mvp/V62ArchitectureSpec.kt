...
object V62ArchitectureSpec {
    ...
    val eventFlow = listOf("PROFILE_CHANGED", "FAMILY_CHANGED", "ADDRESS_CHANGED", "RELATIONSHIP_CHANGED", "REPAYMENT_CHANGED", "DOCUMENT_ADDED", "ASSET_CHANGED", "LIABILITY_CHANGED", "POLICY_CHANGED", "TTMM_EXPENSE_CHANGED", "TTMM_CONTRIBUTION_CHANGED", "SAVINGS_CHANGED", "CONSENT_CHANGED", "NOMINEE_CHANGED", "CLAIM_CHANGED", "WILL_CHANGED", "TRADE_CREDIT_IMPORTED", "FORMAL_LOAN_CHANGED", "CHARGECHECK_CHANGED", "FUNDING_REQUEST_CHANGED", "ALERT_CREATED")
