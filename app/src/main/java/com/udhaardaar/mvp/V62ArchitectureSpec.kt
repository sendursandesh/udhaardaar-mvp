...
object V62ArchitectureSpec {
    ...
    val consentEvents = listOf("HISTORY_SHARING", "CREDIT_REGISTRATION", "DOCUMENT_CONFIRMATION", "REPAYMENT_CONFIRMATION", "FUNDING_PROFILE_SHARING", "ERP_DATA_SHARING", "CLAIM_DATA_SHARING", "LEGAL_HANDOFF")
