...
object V62ArchitectureSpec {
    ...
    val misMetrics = listOf("assetAllocation", "returns", "risk", "idleFunds", "averageInvestment", "investmentPeriod", "charges", "interestReceived", "opportunityCost", "appSavings", "opportunityCostSaved", "formalCreditCost", "informalCreditExposure", "completedBenefitValue", "completedRefundValue", "completedRecoveryValue", "valueGenerated")
    val eventFlow = listOf("PROFILE_CHANGED", "FAMILY_CHANGED", "ADDRESS_CHANGED", "RELATIONSHIP_CHANGED", "REPAYMENT_CHANGED", "DOCUMENT_ADDED", "ASSET_CHANGED", "LIABILITY_CHANGED", "POLICY_CHANGED", "TTMM_EXPENSE_CHANGED", "TTMM_CONTRIBUTION_CHANGED", "TTMM_SETTLEMENT_CHANGED", "SAVINGS_CHANGED", "CONSENT_CHANGED", "NOMINEE_CHANGED", "CLAIM_CHANGED", "WILL_CHANGED", "TRADE_CREDIT_IMPORTED", "FORMAL_LOAN_CHANGED", "CHARGECHECK_CHANGED", "FUNDING_REQUEST_CHANGED", "ALERT_CREATED")
    val endpoints = mapOf("profile" to "profile/create-or-select", "family" to "family/member/upsert", "address" to "profile/address/resolve", "history" to "relationship/history-with-consent", "credit" to "relationship/credit/register-with-consent", "qrKhata" to "qr-khata/entry", "tradeCredit" to "trade-credit/register-or-import", "accounting" to "integrations/accounting/sync", "formalCredit" to "formal-credit/compare-and-apply", "funding" to "funding/request-and-discover", "repayment" to "relationship/repayment/record", "chargeCheck" to "chargecheck/analyse", "rental" to "relationship/rental/register", "ttmm" to "ttmm/expense-and-settlement", "ttmmContribution" to "ttmm/contribution/record", "asset" to "vault/asset/upsert", "liability" to "vault/liability/upsert", "insurance" to "vault/insurance/upsert", "document" to "documents/store-index-and-analyse", "mis" to "mis/refresh-from-events", "legacy" to "legacy/will-nominee-claim", "legal" to "legal/assistance", "ai" to "ai/advisor-and-document-intelligence", "alerts" to "alerts/evaluate")
    val nonNegotiableRules = listOf(
        ...
        "TTMM supports group expenses where one member pays initially and other members contribute later; contributions remain linked to the originating expense.",
        "Every TTMM contribution is partial/full-settlement aware and cannot exceed the member's outstanding share for that expense.",
