...
class LoginActivity : AppCompatActivity() {
    ...
    private fun shell():LinearLayout=LinearLayout(this).apply{orientation=LinearLayout.VERTICAL;setPadding(dp(20),dp(16),dp(20),dp(18));setBackgroundColor(bg)}
    // Compact first screen: all essential sign-in actions fit without a long scroll surface.
    private fun screen(r:LinearLayout){setContentView(r)}
