...
class V5QrCreditActivity:AppCompatActivity(){
 ...
 private fun e(h:String)=EditText(this).apply{hint=h;setSingleLine(true);textSize=16f;minHeight=dp(52);setPadding(dp(12),dp(8),dp(12),dp(8))}
 ...
 override fun onCreate(b:Bundle?){super.onCreate(b);val r=LinearLayout(this).apply{orientation=LinearLayout.VERTICAL;setPadding(dp(18),dp(18),dp(18),dp(24))};add(r,TextView(this).apply{text="UDHAARDAAR V5 • SCAN QR / PAY OR CREDIT";textSize=20f;setTextColor(Color.rgb(24,58,92));setPadding(0,0,0,dp(8))});add(r,TextView(this).apply{text="No silent credit: transaction → consent → offer → agreement → payment/credit";textSize=14f},48)
