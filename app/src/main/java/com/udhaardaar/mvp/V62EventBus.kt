...
object V62Events {
    ...
    const val QR_KHATA_CHANGED = "QR_KHATA_CHANGED"
    ...
    const val TTMM_CONTRIBUTION_CHANGED = "TTMM_CONTRIBUTION_CHANGED"
    const val TTMM_SETTLEMENT_CHANGED = "TTMM_SETTLEMENT_CHANGED"
