...
/** ArthSaathi V6.2 professional financial command centre. */
class V62HomeActivity : androidx.appcompat.app.AppCompatActivity() {
    ...
    private fun render(){
        ...
        root=LinearLayout(this).apply{orientation=LinearLayout.VERTICAL;setPadding(dp(16),dp(8),dp(16),dp(30));setBackgroundColor(ArthSaathiV62Design.BG)}
        setContentView(ScrollView(this).apply{isFillViewport=true;addView(root)})
        add(ArthSaathiV62Design.title(this,ArthSaathiV62Design.BRAND,ArthSaathiV62Design.TAGLINE),2)
        add(ArthSaathiV62Design.text(this,ArthSaathiV62Design.PILLARS,10f,ArthSaathiV62Design.GOLD,true),1)
        ...
        val hero=LinearLayout(this).apply{orientation=LinearLayout.VERTICAL;setPadding(dp(18),dp(17),dp(18),dp(17));background=ArthSaathiV62Design.hero(ArthSaathiV62Design.NAVY,20,d);elevation=dp(1).toFloat()}
        hero.addView(ArthSaathiV62Design.text(this,"FINANCIAL COMMAND CENTRE",9.5f,ArthSaathiV62Design.GOLD,true))
        ...
        add(stats,9)
        add(ArthSaathiV62Design.section(this,"YOUR FINANCIAL JOURNEY"),9)
        ...
        add(ArthSaathiV62Design.section(this,"PROTECT • LEGACY • ASSIST"),9)
        ...
        val advisor=LinearLayout(this).apply{orientation=LinearLayout.HORIZONTAL;gravity=Gravity.CENTER_VERTICAL;setPadding(dp(15),dp(14),dp(15),dp(14));background=ArthSaathiV62Design.card(ArthSaathiV62Design.PALE_TEAL,16,d)}
        advisor.addView(ArthSaathiV62Design.text(this,"✦",24f,ArthSaathiV62Design.TEAL,true),LinearLayout.LayoutParams(dp(34),dp(46)))
        val copy=LinearLayout(this).apply{orientation=LinearLayout.VERTICAL};copy.addView(ArthSaathiV62Design.text(this,"AI FINANCIAL ADVISOR",9.5f,ArthSaathiV62Design.TEAL,true));copy.addView(ArthSaathiV62Design.text(this,"Connected suggestions from your recorded financial data.",11f,ArthSaathiV62Design.NAVY),LinearLayout.LayoutParams(-1,-2).apply{topMargin=dp(4)});advisor.addView(copy,LinearLayout.LayoutParams(0,-2,1f).apply{leftMargin=dp(7)});add(advisor,12)
