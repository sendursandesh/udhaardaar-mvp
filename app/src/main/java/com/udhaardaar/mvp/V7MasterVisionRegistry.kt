...
object V7MasterVisionRegistry {
    ...
    enum class Module(
        ...
        PROTECT("PROTECT", "Insurance & Protection", Ownership.LEGACY_ADAPTER,
            listOf(V7Core.Keys.POLICIES, V7Core.Keys.CLAIMS, V7Core.Keys.NOMINEES, V7Core.Keys.DOCUMENTS)),
        GROW("GROW", "Portfolio & Financial Intelligence", Ownership.LEGACY_ADAPTER,
            listOf(V7Core.Keys.PORTFOLIOS, V7Core.Keys.HOLDINGS, V7Core.Keys.MARKET, V7Core.Keys.SCENARIOS)),
        LEGAL("LEGAL", "Legal & Claims", Ownership.LEGACY_ADAPTER,
            listOf(V7Core.Keys.LEGAL, V7Core.Keys.CLAIMS, V7Core.Keys.PROFESSIONALS)),
        BENEFITS("BENEFITS", "Government Benefits", Ownership.LEGACY_ADAPTER,
            listOf(V7Core.Keys.SERVICES, V7Core.Keys.ALERTS)),
        TTMM("TTMM", "Together • Share & Settle", Ownership.LEGACY_ADAPTER,
        ...
        TRADE("TRADE", "Trade Credit", Ownership.LEGACY_ADAPTER,
        ...
        MIS("MIS", "MIS & Reports", Ownership.LEGACY_ADAPTER,
        ...
        GUARANTOR("GUARANTOR", "Guarantor", Ownership.LEGACY_ADAPTER,
